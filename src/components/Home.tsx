          ...
          <div className="lg:col-span-7">
            <div className="white-card-thick p-3 sm:p-4 rounded-3xl shadow-2xl bg-white border border-slate-200">
              <div 
                ...
                onClick={() => setPreviewImageUrl(PRODUCTS[0].image)}
              >
                <img
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md p-4 rounded-xl border border-slate-200 flex justify-between items-center text-xs shadow-xl">
                  <div>
                    ...
                    <span className="text-xs text-red-600 font-bold">Precision Embroidery • Heavy Duty Cotton</span>
                  </div>
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                    ...
                    className="px-4 py-2 bg-[#0B2545] text-white rounded-lg font-bold text-xs hover:bg-red-600 transition uppercase tracking-wider shadow"
                  >
                    VIEW SPECS
                  </button>
                </div>
